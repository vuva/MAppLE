...
def basic_dash3(segment_number, bitrates, average_dwn_time,
    ...
    if download_rate > current_bitrate * config_dash.BASIC_UPPER_THRESHOLD:
    ...
    elif download_rate * config_dash.BASIC_LOWER_THRESHOLD < current_bitrate:
        ...
        # If its neither lower nor higher, keep current bitrate
        next_rate = current_bitrate
