...
/* could be factorized with OWD variant. rename some fields too ? */
	...
	struct tcp_delay_est {
		...
		u32	delay;	/* smoothed round trip time << 3 in nsecs */
		u32	mdev;	/* medium deviation			*/
		u32	mdev_max;	/* maximal mdev for the last rtt period	*/
		u32	rttvar;	/* smoothed mdev_max			*/
		u32	rtt_seq;	/* sequence number to update rttvar	*/

		struct  minmax owd_min;
	} owd_out, owd_in;
 ...
 */
	...
	u32	mptcp_data_sacked_out;	// Number of duplicated data ACK received for this path 
...
/* Receiver side RTT estimation */
	...
	*/
	/* struct { */
	/* 	u32	owd; /1* we might use sthg more precise *1/ */
	/* 	u32	seq; */
	/* 	u32	time; */
	/* } rcv_owd_est; */
