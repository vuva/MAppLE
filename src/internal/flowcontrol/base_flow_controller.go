...
func (c *baseFlowController) getWindowUpdate(force bool) protocol.ByteCount {
...
func (c *baseFlowController) GetBytesSent() protocol.ByteCount {
	return c.bytesSent
}

func (c *baseFlowController) AddBytesRetrans(n protocol.ByteCount) {
	c.bytesRetrans += n
}

func (c *baseFlowController) GetBytesRetrans() protocol.ByteCount {
